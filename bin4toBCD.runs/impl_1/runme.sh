...
HD_PWD='E:/Xilinx/Projects/bin4toBCD/bin4toBCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bin4toBCD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bin4toBCD.tcl -notrace

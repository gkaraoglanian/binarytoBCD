...
HD_PWD='E:/Xilinx/Projects/bin4toBCD/bin4toBCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin4toBCD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin4toBCD.tcl
